...
namespace flounder
{
		...
		uiobject(parent, vector2(0.5f, 0.5f), vector2(1.0f, 1.0f))
	{
		...
		m_textCopyright = new text(this, vector2(0.5f, 0.82f), "Copyright (C) 2017, Equilibrium Games - All Rights Reserved. This product uses OpenAL, GLFW, Vulkan, and STB Image.", 1.5f, uis::get()->cafeFrancoise, 0.5f, CENTRE);
