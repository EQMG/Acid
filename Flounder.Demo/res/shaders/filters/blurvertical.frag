...
void main(void) 
{
	...
	blurfragmentUv[0] = fragmentUv + vec2(0.0, -part * 7.0) * ubo.scale;
	blurfragmentUv[1] = fragmentUv + vec2(0.0, -part * 6.0) * ubo.scale;
	blurfragmentUv[2] = fragmentUv + vec2(0.0, -part * 5.0) * ubo.scale;
	blurfragmentUv[3] = fragmentUv + vec2(0.0, -part * 4.0) * ubo.scale;
	blurfragmentUv[4] = fragmentUv + vec2(0.0, -part * 3.0) * ubo.scale;
	blurfragmentUv[5] = fragmentUv + vec2(0.0, -part * 2.0) * ubo.scale;
	blurfragmentUv[6] = fragmentUv + vec2(0.0, -part) * ubo.scale;
	blurfragmentUv[7] = fragmentUv + vec2(0.0, part) * ubo.scale;
	blurfragmentUv[8] = fragmentUv + vec2(0.0, part * 2.0) * ubo.scale;
	blurfragmentUv[9] = fragmentUv + vec2(0.0, part * 3.0) * ubo.scale;
	blurfragmentUv[10] = fragmentUv + vec2(0.0, part * 4.0) * ubo.scale;
	blurfragmentUv[11] = fragmentUv + vec2(0.0, part * 5.0) * ubo.scale;
	blurfragmentUv[12] = fragmentUv + vec2(0.0, part * 6.0) * ubo.scale;
	blurfragmentUv[13] = fragmentUv + vec2(0.0, part * 7.0) * ubo.scale;
