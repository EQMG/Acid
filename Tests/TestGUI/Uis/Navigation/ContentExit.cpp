...
namespace test
{
	ContentExit::ContentExit(UiObject *parent) :
		...
		m_radio1(std::make_unique<UiInputRadio>(m_section1->GetContent(), "First Value", UiInputRadio::Mark::X, false, UiBound(Vector2(0.0f, 0.42f), UiReference::TopLeft))),
		m_radio2(std::make_unique<UiInputRadio>(m_section1->GetContent(), "Second Value", UiInputRadio::Mark::X, true, UiBound(Vector2(0.0f, 0.4725f), UiReference::TopLeft))),
		m_radio3(std::make_unique<UiInputRadio>(m_section1->GetContent(), "Third Value", UiInputRadio::Mark::X, false, UiBound(Vector2(0.0f, 0.525f), UiReference::TopLeft))),
		...
		m_input1(std::make_unique<UiGrabberMouse>(m_section1->GetContent(), "Mouse Grabber", MouseButton::Left, UiBound(Vector2(0.0f, 0.07f), UiReference::TopLeft))),
		m_input2(std::make_unique<UiGrabberKeyboard>(m_section1->GetContent(), "Keyboard Grabber", Key::W, UiBound(Vector2(0.0f, 0.14f), UiReference::TopLeft))),
		m_input3(std::make_unique<UiGrabberJoystick>(m_section1->GetContent(), "Joystick Grabber", 0, 3, UiBound(Vector2(0.0f, 0.21f), UiReference::TopLeft))),
		m_slider1(std::make_unique<UiInputSlider>(m_section1->GetContent(), "Volume", 100.0f, 0.0f, 100.0f, 0, UiBound(Vector2(0.0f, 0.28f), UiReference::TopLeft))),
		m_text1(std::make_unique<UiInputText>(m_section1->GetContent(), "Title", Window::Get()->GetTitle(), 14, UiBound(Vector2(0.0f, 0.35f), UiReference::TopLeft))),
		m_sliderR(std::make_unique<UiInputSlider>(GetContent(), "R", 255.0f, 0.0f, 255.0f, 0, UiBound(Vector2(0.657f, 0.12f), UiReference::TopRight))),
		m_sliderG(std::make_unique<UiInputSlider>(GetContent(), "G", 255.0f, 0.0f, 255.0f, 0, UiBound(Vector2(0.79f, 0.12f), UiReference::TopRight))),
		m_sliderB(std::make_unique<UiInputSlider>(GetContent(), "B", 0.0f, 0.0f, 255.0f, 0, UiBound(Vector2(0.92f, 0.12f), UiReference::TopRight))),
		m_rgbColour(std::make_unique<Gui>(GetContent(), UiBound(Vector2(0.92f, 0.19f), UiReference::TopRight, UiAspect::Position | UiAspect::Dimensions, Vector2(0.3f, 0.045f)), Texture::Create("Guis/Button_Full.png"), Colour::Yellow)),
		m_colourWheel(std::make_unique<UiColourWheel>(GetContent(), Colour::Purple, UiBound(Vector2(0.92f, 0.26f), UiReference::TopRight)))
	{
