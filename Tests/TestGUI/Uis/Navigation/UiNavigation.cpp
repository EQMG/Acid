...
namespace test
{
		...
		m_targetTab(nullptr)
	{
		...
		m_barTitle = std::make_unique<Text>(this, UiBound(Vector2(0.01f, 0.99f), "TopLeft", false), 4.0f, "Testing", FontType::Resource("Fonts/ProximaNova", "Bold"), TEXT_JUSTIFY_LEFT, 1.0f, 0.001f);
		m_barCreatedBy = std::make_unique<Text>(this, UiBound(Vector2(0.02f, 0.915f), "TopLeft", false), 1.1f, "Created By: Equilibrium Games", FontType::Resource("Fonts/ProximaNova", "Light"), TEXT_JUSTIFY_LEFT, 1.0f, 0.0013f);
