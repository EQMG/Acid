...
OverlayDebug::OverlayDebug(UiObject *parent) :
	...
	//m_slices(this, UiTransform(Vector2f(0.5f, 0.5f), UiAnchor::Centre, UiAspect::Position | UiAspect::Scale), Image2d::Create("Guis/9Patch.png")),
...
{
	//m_slices.GetTransform().SetSize(2.0f * (Vector2f(0.5f, 0.5f) - Mouse::Get()->GetPosition()));
