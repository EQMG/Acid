...
namespace test
{
	...
	{
		auto result = std::make_unique<Text>(this, UiBound(Vector2(positionX, positionY), UiBound::BottomLeft), 1.1f, content, FontType::Create("Fonts/ProximaNova", "Regular"), justify);
