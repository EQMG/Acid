...
Panels::Panels() {
	...
	m_gui0.GetContent().AddChild(&m_dropdown0);
	...
	m_gui0.GetContent().AddChild(&m_grabber0);
	...
	m_gui0.GetContent().AddChild(&m_grabber1);
	...
	m_gui0.GetContent().AddChild(&m_slider0);
