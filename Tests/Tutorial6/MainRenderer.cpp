...
public:
	explicit Tutorial6(const Pipeline::Stage &stage) :
		Subrender(stage), m_pipeline(stage, {"Tutorial/Shaders/tri6.vert", "Tutorial/Shaders/tri6.frag"},
			vertexInputs, {}, PipelineGraphics::Mode::Polygon, PipelineGraphics::Depth::ReadWrite,
