...
namespace acid
{
	...
	static void Bezier2Points(Vector2 &q0, Vector2 &q1, Vector2 &r, const Vector2 bezier[3], const float &t); // private
	...
	static float Bezier2Component(const float &p0, const float &p1, const float &p2, const float &t); // private
