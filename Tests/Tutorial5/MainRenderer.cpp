 ...
 */
class Tutorial5 : public Subrender {
public:
...
protected:
	 ...
	 */
public:
	explicit Tutorial5(const Pipeline::Stage &stage) :
		Subrender(stage),
		m_pipeline(stage,
			{"Tutorial/Shaders/tri5.vert", "Tutorial/Shaders/tri5.frag"},
...
void MainRenderer::Start() {
	 ...
	 */
	const std::vector<Tutorial5::Vertex> vertices = {
	 ...
	 */
	auto Square = AddSubrender<Tutorial5>({0, 0});
