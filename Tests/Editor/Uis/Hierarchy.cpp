...
Hierarchy::Hierarchy(UiObject *parent) :
	...
	m_sliderG(&m_section1.GetContent(), "G", 255.0f, 0.0f, 255.0f, 0, UiTransform(Vector2f(0.074f, 0.06f), UiAnchor::LeftTop)),
	m_sliderB(&m_section1.GetContent(), "B", 0.0f, 0.0f, 255.0f, 0, UiTransform(Vector2f(0.1475f, 0.06f), UiAnchor::LeftTop)),
	m_textHex(&m_section1.GetContent(), "Hex", Colour::Yellow.GetHex(), 14, UiTransform(Vector2f(0.0f, 0.12f), UiAnchor::LeftTop)),
	m_rgbColour(&m_section1.GetContent(), UiTransform(Vector2f(0.0f, 0.18f), UiAnchor::LeftTop, UiInputButton::Size),
		Image2d::Create("Guis/Button_Filled.png"), Colour::Yellow)
	//m_colourWheel(&m_section1.GetContent(), Colour::Yellow, UiTransform(Vector2f(0.0f, 0.24f), UiAnchor::LeftTop))
{
