...
void main(void) 
{
	...
	blurTextureCoords[0] = textureCoords + vec2(-part * 7.0, 0.0) * ubo.scale;
	blurTextureCoords[1] = textureCoords + vec2(-part * 6.0, 0.0) * ubo.scale;
	blurTextureCoords[2] = textureCoords + vec2(-part * 5.0, 0.0) * ubo.scale;
	blurTextureCoords[3] = textureCoords + vec2(-part * 4.0, 0.0) * ubo.scale;
	blurTextureCoords[4] = textureCoords + vec2(-part * 3.0, 0.0) * ubo.scale;
	blurTextureCoords[5] = textureCoords + vec2(-part * 2.0, 0.0) * ubo.scale;
	blurTextureCoords[6] = textureCoords + vec2(-part, 0.0) * ubo.scale;
	blurTextureCoords[7] = textureCoords + vec2(part, 0.0) * ubo.scale;
	blurTextureCoords[8] = textureCoords + vec2(part * 2.0, 0.0) * ubo.scale;
	blurTextureCoords[9] = textureCoords + vec2(part * 3.0, 0.0) * ubo.scale;
	blurTextureCoords[10] = textureCoords + vec2(part * 4.0, 0.0) * ubo.scale;
	blurTextureCoords[11] = textureCoords + vec2(part * 5.0, 0.0) * ubo.scale;
	blurTextureCoords[12] = textureCoords + vec2(part * 6.0, 0.0) * ubo.scale;
	blurTextureCoords[13] = textureCoords + vec2(part * 7.0, 0.0) * ubo.scale;
