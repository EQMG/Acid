...
{
	m_objects.erase(std::remove_if(m_objects.begin(), m_objects.end(), [object](std::unique_ptr<Entity>& e) { return e.get() == object; }), m_objects.end());
}
...
/*std::vector<Entity
*>
SceneStructure::QuerySphere(const
Vector3
&centre,
const
Vector3
...
/*std::vector<Entity
*>
SceneStructure::QueryCube(const
Vector3
&min,
const
Vector3
