...
namespace acid
{
template<> const Vector3f Vector3f::Zero = Vector3f(0.0f);
template<> const Vector3f Vector3f::One = Vector3f(1.0f);
...
template<> const Vector3f Vector3f::PositiveInfinity = Vector3f(+std::numeric_limits<float>::infinity());
template<> const Vector3f Vector3f::NegativeInfinity = Vector3f(-std::numeric_limits<float>::infinity());

template<> const Vector3d Vector3d::Zero = Vector3d(0.0);
template<> const Vector3d Vector3d::One = Vector3d(1.0);
...
template<> const Vector3d Vector3d::PositiveInfinity = Vector3d(+std::numeric_limits<double>::infinity());
template<> const Vector3d Vector3d::NegativeInfinity = Vector3d(-std::numeric_limits<double>::infinity());

template<> const Vector3i Vector3i::Zero = Vector3i(0);
template<> const Vector3i Vector3i::One = Vector3i(1);
...
template<> const Vector3i Vector3i::PositiveInfinity = Vector3i(+std::numeric_limits<int32_t>::infinity());
template<> const Vector3i Vector3i::NegativeInfinity = Vector3i(-std::numeric_limits<int32_t>::infinity());

template<> const Vector3ui Vector3ui::Zero = Vector3ui(0);
template<> const Vector3ui Vector3ui::One = Vector3ui(1);
}
