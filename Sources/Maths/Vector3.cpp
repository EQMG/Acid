...
Vector3::Vector3(const Vector2& source, const float& z) : m_x(source.m_x), m_y(source.m_y), m_z(z) {}

Vector3::Vector3(const Vector4& source) : m_x(source.m_x), m_y(source.m_y), m_z(source.m_z) {}

Vector3::Vector3(const Colour& source) : m_x(source.m_r), m_y(source.m_g), m_z(source.m_b) {}
