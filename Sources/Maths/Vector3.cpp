...
template<> const Vector3f Vector3f::PositiveInfinity = Vector3f(+std::numeric_limits<float>::infinity(), +std::numeric_limits<float>::infinity(), +std::numeric_limits<float>::infinity());
template<> const Vector3f Vector3f::NegativeInfinity = Vector3f(-std::numeric_limits<float>::infinity(), -std::numeric_limits<float>::infinity(), -std::numeric_limits<float>::infinity());
...
template<> const Vector3d Vector3d::PositiveInfinity = Vector3d(+std::numeric_limits<double>::infinity(), +std::numeric_limits<double>::infinity(), +std::numeric_limits<double>::infinity());
template<> const Vector3d Vector3d::NegativeInfinity = Vector3d(-std::numeric_limits<double>::infinity(), -std::numeric_limits<double>::infinity(), -std::numeric_limits<double>::infinity());
...
template<> const Vector3i Vector3i::PositiveInfinity = Vector3i(+std::numeric_limits<int32_t>::infinity(), +std::numeric_limits<int32_t>::infinity(), +std::numeric_limits<int32_t>::infinity());
template<> const Vector3i Vector3i::NegativeInfinity = Vector3i(-std::numeric_limits<int32_t>::infinity(), -std::numeric_limits<int32_t>::infinity(), -std::numeric_limits<int32_t>::infinity());
