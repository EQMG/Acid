...
template<> const Vector2f Vector2f::PositiveInfinity = Vector2f(+std::numeric_limits<float>::infinity(), +std::numeric_limits<float>::infinity());
template<> const Vector2f Vector2f::NegativeInfinity = Vector2f(-std::numeric_limits<float>::infinity(), -std::numeric_limits<float>::infinity());
...
template<> const Vector2d Vector2d::PositiveInfinity = Vector2d(+std::numeric_limits<double>::infinity(), +std::numeric_limits<double>::infinity());
template<> const Vector2d Vector2d::NegativeInfinity = Vector2d(-std::numeric_limits<double>::infinity(), -std::numeric_limits<double>::infinity());
...
template<> const Vector2i Vector2i::PositiveInfinity = Vector2i(+std::numeric_limits<int32_t>::infinity(), +std::numeric_limits<int32_t>::infinity());
template<> const Vector2i Vector2i::NegativeInfinity = Vector2i(-std::numeric_limits<int32_t>::infinity(), -std::numeric_limits<int32_t>::infinity());
