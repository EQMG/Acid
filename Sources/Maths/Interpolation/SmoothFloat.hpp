...
class SmoothFloat
{
  public:
	...
	/// actual.
	/// </param>
	SmoothFloat(const T& initialValue, const float& agility) : m_agility(agility), m_target(initialValue), m_actual(initialValue) {}
	...
	/// by.
	/// </param>
	void IncreaseTarget(const T& increase)
	{
		m_target += increase;
	}
