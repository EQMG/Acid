...
/// </summary>
template<typename T>
class DriverFade : public IDriver<T>
{
  public:
	/// <summary>
	/// Creates
	...
	/// end.
	/// </param>
	DriverFade(const T& start, const T& end, const T& peak, const Time& length) : IDriver<T>(length), m_start(start), m_end(end), m_peak(peak) {}
