...
{
/// <summary>
/// Class that represents a disk model.
/// </summary>
...
public:
	/// <summary>
	/// Will find an existing disk model with the same values, or create a new disk model.
	/// </summary>
	...
	/// <param name="loops"> The amount of circles that will be created between the inner and outer radius. </param>
