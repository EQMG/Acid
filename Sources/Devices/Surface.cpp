...
namespace acid
{
Surface::Surface(const Instance* instance, const PhysicalDevice* physicalDevice) : m_instance(instance), m_physicalDevice(physicalDevice), m_surface(VK_NULL_HANDLE), m_capabilities({}), m_format({})
{
	// Creates
	// the
	// surface.
