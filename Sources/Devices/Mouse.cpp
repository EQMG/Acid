...
Mouse::Mouse() : m_lastMousePositionX(0.0f), m_lastMousePositionY(0.0f), m_mousePositionX(0.0f), m_mousePositionY(0.0f), m_mouseDeltaX(0.0f), m_mouseDeltaY(0.0f), m_mouseDeltaWheel(0.0f), m_windowSelected(true), m_cursorHidden(false)
{
