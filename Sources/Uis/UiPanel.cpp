...
UiPanel::UiPanel(UiObject* parent, const UiBound& rectangle, const BitMask<ScrollBar>& scrollBars)
	: UiObject(parent, rectangle), m_background(this, UiBound::Maximum, Texture::Create("Guis/White.png"), UiInputButton::BackgroundColour), m_content(this, UiBound::Maximum),
	  ...
	  m_scrollY(this, ScrollBar::Vertical, UiBound(Vector2(1.0f, 0.0f), UiReference::TopRight, UiAspect::Position | UiAspect::Dimensions, Vector2(SCROLL_BAR.m_x, SCROLL_BAR.m_y))), m_scrollBars(scrollBars)
{
}
...
void UiPanel::UpdateObject()
{
	...
	//	m_content.GetRectangle().SetPosition(0.5f
	//-
	//(Vector2(m_scrollX->GetProgress(),
	// m_scrollY->GetProgress())
	//*
	// contentSize));
