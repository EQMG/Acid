...
namespace acid
{
	...
	public:
		...
		explicit UiBound(const Vector2 &position = Vector2::Zero, const Vector2 &reference = UiReference::TopLeft, 
			const bitmask<UiAspect> &aspect = UiAspect::Position | UiAspect::Dimensions, const Vector2 &dimensions = Vector2::One);
