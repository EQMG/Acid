...
namespace acid
{
const Vector2i UiInputButton::Size = Vector2f(141, 29);
const uint32_t UiInputButton::Padding = 4;
const uint32_t UiInputButton::FontSize = 12;
...
UiInputButton::UiInputButton(UiObject *parent, const std::string &string, const UiTransform &transform) :
	...
	m_background(this, UiTransform(transform.GetSize(), Vector2i(), UiAnchor::Centre), Image2d::Create("Guis/Button_Filled.png"), PrimaryColour),
	m_text(this, UiTransform(transform.GetSize() - (2 * Padding), Vector2i(), UiAnchor::Centre), FontSize, string, FontType::Create("Fonts/ProximaNova", "Regular"), Text::Justify::Left, ValueColour)
{
