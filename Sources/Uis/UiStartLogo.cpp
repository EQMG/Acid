...
namespace fl
{
	UiStartLogo::UiStartLogo(UiObject *parent) :
		...
		m_textCopyright(new Text(this, UiBound(Vector2(0.5f, 0.2f), "Centre", true), 1.4f, "Copyright (C) 2018, Equilibrium Games - All Rights Reserved. This product uses GLFW, Vulkan, MoltenVK, OpenAL, and STB Image", FontType::Resource("Fonts/ProximaNova", FAMILY_REGULAR), JUSTIFY_CENTRE, 0.8f, 0.0012f, 0.024f)),
		m_starting(true)
	{
