...
UiStartLogo::UiStartLogo(UiObject *parent) :
	...
	m_guiBackground(this, UiBound(Vector2(0.5f, 0.5f), UiReference::Centre, UiAspect::Position, Vector2(1.0f, 1.0f)), Image2d::Create("Guis/Black.png")),
	m_guiLogoAcid(this, UiBound(Vector2(0.5f, 0.5f), UiReference::Centre, UiAspect::Position | UiAspect::Dimensions, Vector2(0.4f, 0.4f)), Image2d::Create("Logos/Acid_01.png")),
	m_textCopyright(this, UiBound(Vector2(0.5f, 0.8f), UiReference::Centre, UiAspect::Position | UiAspect::Dimensions), 1.8f,
