...
namespace fl
{
	UiStartLogo::UiStartLogo(UiObject *parent) :
		...
		m_guiLogo(new Gui(this, UiBound(Vector2(0.5f, 0.5f), "Centre", true, true, Vector2(0.4f, 0.4f)), Texture::Resource("Logos/Equilibrium-Games-02.png"), 1)),
		m_textCopyright(new Text(this, UiBound(Vector2(0.5f, 0.2f), "Centre", true), 1.4f, "Copyright (C) 2018, Equilibrium Games - All Rights Reserved. This product uses GLFW, Vulkan, MoltenVK, OpenAL, and STB Image", FontFamily::Resource("Fonts/ProximaNova", FAMILY_REGULAR), JUSTIFY_CENTRE, 0.8f, 0.0012f, 0.024f)),
		m_starting(true)
	{
