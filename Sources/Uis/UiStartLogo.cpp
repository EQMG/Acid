...
namespace acid
{
	UiStartLogo::UiStartLogo(UiObject *parent) :
		...
		m_guiBackground(std::make_unique<Gui>(this, UiBound(Vector2(0.5f, 0.5f), UiBound::CENTRE, true, true, Vector2(1.0f, 1.0f)), Texture::Resource("Guis/Black.png"))),
		...
		m_textCopyright(std::make_unique<Text>(this, UiBound(Vector2(0.5f, 0.2f), UiBound::CENTRE, true), 1.8f, "Copyright (C) 2018, Equilibrium Games - All Rights Reserved.", FontType::Resource("Fonts/ProximaNova", "Regular"), TEXT_JUSTIFY_CENTRE, 0.8f, 0.0012f, 0.024f)),
		m_starting(true)
	{
