...
UiStartLogo::UiStartLogo(UiObject *parent) :
	...
	m_guiLogoAcid(this, UiBound(Vector2f(0.5f, 0.5f), UiReference::Centre, UiAspect::Position | UiAspect::Size, Vector2f(0.4f, 0.4f)), Image2d::Create("Logos/Acid_01.png")),
	m_textCopyright(this, UiBound(Vector2f(0.5f, 0.8f), UiReference::Centre, UiAspect::Position | UiAspect::Size), 1.8f,
