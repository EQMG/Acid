...
namespace acid
{
	UiStartLogo::UiStartLogo(UiObject *parent) :
		...
		m_textCopyright(std::make_unique<Text>(this, UiBound(Vector2(0.5f, 0.2f), "Centre", true), 1.8f, "Copyright (C) 2018, Equilibrium Games - All Rights Reserved.", FontType::Resource("Fonts/ProximaNova", "Regular"), JUSTIFY_CENTRE, 0.8f, 0.0012f, 0.024f)),
		m_starting(true)
	{
