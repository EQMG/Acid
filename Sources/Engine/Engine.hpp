...
class ACID_EXPORT Engine : public NonCopyable
{
  public:
	...
	/// offset.
	/// </returns>
	const Time& GetTimeOffset() const
	{
		return m_timeOffset;
	}
	...
	/// offset.
	/// </param>
	void SetTimeOffset(const Time& timeOffset)
	{
	...
	/// limit.
	/// </param>
	void SetFpsLimit(const float& fpsLimit)
	{
		m_fpsLimit = fpsLimit;
	}
	...
	{
		return m_moduleUpdater.GetDelta();
	}
	...
	{
		return m_moduleUpdater.GetDeltaRender();
	}
