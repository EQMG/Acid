...
void main() 
{
	...
	float part = 1.0 / scene.width;

	vec2 blurfragmentUv[14];
	blurfragmentUv[0] = fragmentUv + vec2(-part * 7.0, 0.0) * scene.scale;
	blurfragmentUv[1] = fragmentUv + vec2(-part * 6.0, 0.0) * scene.scale;
	blurfragmentUv[2] = fragmentUv + vec2(-part * 5.0, 0.0) * scene.scale;
	blurfragmentUv[3] = fragmentUv + vec2(-part * 4.0, 0.0) * scene.scale;
	blurfragmentUv[4] = fragmentUv + vec2(-part * 3.0, 0.0) * scene.scale;
	blurfragmentUv[5] = fragmentUv + vec2(-part * 2.0, 0.0) * scene.scale;
	blurfragmentUv[6] = fragmentUv + vec2(-part, 0.0) * scene.scale;
	blurfragmentUv[7] = fragmentUv + vec2(part, 0.0) * scene.scale;
	blurfragmentUv[8] = fragmentUv + vec2(part * 2.0, 0.0) * scene.scale;
	blurfragmentUv[9] = fragmentUv + vec2(part * 3.0, 0.0) * scene.scale;
	blurfragmentUv[10] = fragmentUv + vec2(part * 4.0, 0.0) * scene.scale;
	blurfragmentUv[11] = fragmentUv + vec2(part * 5.0, 0.0) * scene.scale;
	blurfragmentUv[12] = fragmentUv + vec2(part * 6.0, 0.0) * scene.scale;
	blurfragmentUv[13] = fragmentUv + vec2(part * 7.0, 0.0) * scene.scale;
