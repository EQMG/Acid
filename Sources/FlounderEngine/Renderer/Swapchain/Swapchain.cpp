...
namespace Flounder
{
		...
		m_extent({})
	{
		...
		m_shadowImage = new Texture(8192, 8192, VK_FORMAT_R16_UNORM, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT); // Shadows::Get()->GetShadowSize(), Shadows::Get()->GetShadowSize()
	}
