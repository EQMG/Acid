...
{
  public:
	Material() : m_pipelineMaterial(nullptr) {}
	...
	/// pipeline.
	/// </returns>
	const std::shared_ptr<PipelineMaterial>& GetPipelineMaterial() const
	{
		return m_pipelineMaterial;
	}
