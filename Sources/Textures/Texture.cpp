...
namespace fl
{
	...
	{
		const auto commandBuffer = Renderer::BeginVkSingleCommands();
		...
		Renderer::EndVkSingleCommands(commandBuffer);
	}
	...
	{
		VkCommandBuffer commandBuffer = Renderer::BeginVkSingleCommands();
