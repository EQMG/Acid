...
namespace acid
{
Rigidbody::Rigidbody(const float& mass, const float& friction, const Vector3& linearFactor, const Vector3& angularFactor) : CollisionObject(friction), m_mass(mass), m_linearFactor(linearFactor), m_angularFactor(angularFactor), m_rigidBody(nullptr) {}
...
void Rigidbody::Start()
{
	...
	//	m_rigidBody->setContactStiffnessAndDamping(1000.0f,
	// 0.1f);
