...
namespace acid
{
KinematicCharacter::KinematicCharacter(const float& friction) : CollisionObject(friction), m_up(Vector3::Up), m_stepHeight(0.0f), m_fallSpeed(55.0f), m_jumpSpeed(10.0f), m_maxHeight(1.5f), m_interpolate(true), m_ghostObject(nullptr), m_controller(nullptr) {}
