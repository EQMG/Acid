...
EntityMoon::EntityMoon(const Transform &transform, ISpatialStructure<Entity *> *structure) :
	Entity(transform, structure)
{
	...
	AddComponent(new ComponentGlow(Texture::Resource("Resources/Entities/Moon/Glow.png")));
