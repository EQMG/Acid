...
namespace Demo
{
		...
		UiObject(parent, UiBound(Vector2(0.5f, 0.5f), "Centre", true, true, Vector2(1.0f, 1.0f)))
	{
		...
		Texture *textureInv = new Texture("Resources/Guis/Geometry-Grain.png");
		...
		//	Gui *guiExample = new Gui(uiExamples, *textExample->GetRectangle(), new Texture("Resources/Guis/Geometry-Grain.jpg"), 1);
