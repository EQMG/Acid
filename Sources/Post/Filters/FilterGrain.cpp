...
namespace acid
{
FilterGrain::FilterGrain(const Pipeline::Stage& pipelineStage, const float& strength) : PostFilter(pipelineStage, {"Shaders/Post/Default.vert", "Shaders/Post/Grain.frag"}, {}), m_strength(strength) {}
