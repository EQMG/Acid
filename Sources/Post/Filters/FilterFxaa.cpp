...
namespace acid
{
FilterFxaa::FilterFxaa(const Pipeline::Stage& pipelineStage, const float& spanMax) : PostFilter(pipelineStage, {"Shaders/Post/Default.vert", "Shaders/Post/Fxaa.frag"}, {}), m_spanMax(spanMax) {}
