...
namespace acid
{
FilterPixel::FilterPixel(const Pipeline::Stage& pipelineStage, const float& pixelSize) : PostFilter(pipelineStage, {"Shaders/Post/Default.vert", "Shaders/Post/Pixel.frag"}, {}), m_pixelSize(pixelSize) {}
