...
RendererFonts2::RendererFonts2(const Pipeline::Stage &pipelineStage) :
	...
	m_pipeline(pipelineStage, { "Shaders/Fonts2/Font.vert", "Shaders/Fonts2/Font.frag" }, { FontType::GetVertexInput() }, {}, PipelineGraphics::Mode::Polygon, PipelineGraphics::Depth::None,
		VK_PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP, VK_POLYGON_MODE_FILL, VK_CULL_MODE_BACK_BIT, VK_FRONT_FACE_COUNTER_CLOCKWISE)
{
}
