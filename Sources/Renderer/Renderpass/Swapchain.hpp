...
class ACID_EXPORT Swapchain
{
  public:
	...
	const VkSurfaceTransformFlagsKHR& GetPreTransform() const
	{
		return m_preTransform;
	}

	const VkCompositeAlphaFlagBitsKHR& GetCompositeAlpha() const
	{
	...
	{
		return m_extent.width == extent2D.width && m_extent.height == extent2D.height;
	}
