...
namespace acid
{
Buffer::Buffer(const VkDeviceSize& size, const VkBufferUsageFlags& usage, const VkMemoryPropertyFlags& properties, const void* data) : m_size(size), m_buffer(VK_NULL_HANDLE), m_bufferMemory(VK_NULL_HANDLE)
{
