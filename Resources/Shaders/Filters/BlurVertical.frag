...
void main()
{
	...
	blurTextureCoords[0] = fragmentUv + vec2(0.0f, -part * 7.0f) * scene.scale;
	blurTextureCoords[1] = fragmentUv + vec2(0.0f, -part * 6.0f) * scene.scale;
	blurTextureCoords[2] = fragmentUv + vec2(0.0f, -part * 5.0f) * scene.scale;
	blurTextureCoords[3] = fragmentUv + vec2(0.0f, -part * 4.0f) * scene.scale;
	blurTextureCoords[4] = fragmentUv + vec2(0.0f, -part * 3.0f) * scene.scale;
	blurTextureCoords[5] = fragmentUv + vec2(0.0f, -part * 2.0f) * scene.scale;
	blurTextureCoords[6] = fragmentUv + vec2(0.0f, -part) * scene.scale;
	blurTextureCoords[7] = fragmentUv + vec2(0.0f, part) * scene.scale;
	blurTextureCoords[8] = fragmentUv + vec2(0.0f, part * 2.0f) * scene.scale;
	blurTextureCoords[9] = fragmentUv + vec2(0.0f, part * 3.0f) * scene.scale;
	blurTextureCoords[10] = fragmentUv + vec2(0.0f, part * 4.0f) * scene.scale;
	blurTextureCoords[11] = fragmentUv + vec2(0.0f, part * 5.0f) * scene.scale;
	blurTextureCoords[12] = fragmentUv + vec2(0.0f, part * 6.0f) * scene.scale;
	blurTextureCoords[13] = fragmentUv + vec2(0.0f, part * 7.0f) * scene.scale;
