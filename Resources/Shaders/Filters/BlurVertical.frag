...
void main() 
{
	...
	float part = 1.0 / scene.size.y;

	vec2 blurfragmentUv[14];
	blurfragmentUv[0] = fragmentUv + vec2(0.0, -part * 7.0) * scene.blurAmount;
	blurfragmentUv[1] = fragmentUv + vec2(0.0, -part * 6.0) * scene.blurAmount;
	blurfragmentUv[2] = fragmentUv + vec2(0.0, -part * 5.0) * scene.blurAmount;
	blurfragmentUv[3] = fragmentUv + vec2(0.0, -part * 4.0) * scene.blurAmount;
	blurfragmentUv[4] = fragmentUv + vec2(0.0, -part * 3.0) * scene.blurAmount;
	blurfragmentUv[5] = fragmentUv + vec2(0.0, -part * 2.0) * scene.blurAmount;
	blurfragmentUv[6] = fragmentUv + vec2(0.0, -part) * scene.blurAmount;
	blurfragmentUv[7] = fragmentUv + vec2(0.0, part) * scene.blurAmount;
	blurfragmentUv[8] = fragmentUv + vec2(0.0, part * 2.0) * scene.blurAmount;
	blurfragmentUv[9] = fragmentUv + vec2(0.0, part * 3.0) * scene.blurAmount;
	blurfragmentUv[10] = fragmentUv + vec2(0.0, part * 4.0) * scene.blurAmount;
	blurfragmentUv[11] = fragmentUv + vec2(0.0, part * 5.0) * scene.blurAmount;
	blurfragmentUv[12] = fragmentUv + vec2(0.0, part * 6.0) * scene.blurAmount;
	blurfragmentUv[13] = fragmentUv + vec2(0.0, part * 7.0) * scene.blurAmount;
