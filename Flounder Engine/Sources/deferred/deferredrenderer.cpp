...
namespace flounder {
	deferredrenderer::deferredrenderer()
	{
		m_shader = shader::newShader()->addName("deferredRenderer")
			->addType(shadertype(GL_VERTEX_SHADER, "Resources/shaders/deferred/deferredVertex.glsl", loadtype::FILE))
			->addType(shadertype(GL_FRAGMENT_SHADER, "Resources/shaders/deferred/deferredFragment.glsl", loadtype::FILE))->create();
