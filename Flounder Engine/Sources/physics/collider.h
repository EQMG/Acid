...
namespace flounder {
	...
	public:
		...
		virtual collider *update(vector3 *position, vector3 *rotation, const float &scale, collider *destination) = 0;
		...
		/// </summary>
		/// <param name="other"> The other ray being tested for intersection. </param>
