 ...
 */
class ACID_SOUND_EXPORT Audio : public Module::Registrar<Audio> {
...
public:
	...
	ACID_SOUND_NO_EXPORT static std::string StringifyResultAl(int32_t result);
	ACID_SOUND_NO_EXPORT static void CheckAl(int32_t result);
