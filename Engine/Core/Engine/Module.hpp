 ...
 */
class ACID_CORE_EXPORT Module : public ModuleFactory<Module>, NonCopyable {
public:
	/**
...
template class ACID_CORE_EXPORT TypeInfo<Module>;

class ACID_CORE_EXPORT ModuleFilter {
public:
	ModuleFilter() {
