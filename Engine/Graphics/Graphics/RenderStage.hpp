 ...
 */
class ACID_GRAPHICS_EXPORT Attachment {
public:
	enum class Type {
...
class ACID_GRAPHICS_EXPORT SubpassType {
public:
...
class ACID_GRAPHICS_EXPORT RenderArea {
public:
...
class ACID_GRAPHICS_EXPORT Viewport {
public:
	Viewport() = default;
...
class ACID_GRAPHICS_EXPORT RenderStage {
