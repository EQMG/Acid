 ...
 */
class ACID_CONTEXT_EXPORT Windows : public Module::Registrar<Windows> {
...
public:
	...
	ACID_CONTEXT_NO_EXPORT static std::string StringifyResultGlfw(int32_t result);
	ACID_CONTEXT_NO_EXPORT static void CheckGlfw(int32_t result);
