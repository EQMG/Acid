if(APPLE)
	...
	set(LIBRARIES_INCLUDES ${LIBRARIES_INCLUDES} "${METAL_INCLUDES}" "${IOSURFACE_INCLUDES}" "${QUARTZCORE_INCLUDES}" PARENT_SCOPE)
	set(LIBRARIES_LINKS ${LIBRARIES_LINKS} "${METAL_LIBRARY}" "${IOSURFACE_LIBRARY}" "${QUARTZCORE_LIBRARY}" PARENT_SCOPE)
...
set(LIBRARIES_INCLUDES ${LIBRARIES_INCLUDES} "${VULKAN_INCLUDES}" PARENT_SCOPE)
set(LIBRARIES_LINKS ${LIBRARIES_LINKS} "${VULKAN_LIBRARY}" PARENT_SCOPE)
