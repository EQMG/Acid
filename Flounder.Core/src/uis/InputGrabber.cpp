...
namespace Flounder
{
	...
	InputGrabber::InputGrabber(UiObject *parent, const Vector2 &position, const std::string &prefix, const int &value, IGrabber *grabber, const Justify &justify) :
		UiObject(parent, position, Vector2(0.0f, 0.0f), Vector2(0.5f, 0.5f), true),
		m_text(new Text(this, position, Vector2(0.5f, 0.5f), prefix + grabber->GetValue(value), SCALE_NORMAL, Uis::Get()->m_candara, 0.36f, justify)),
