...
namespace Flounder
{
	OverlayStartup::OverlayStartup(UiObject *parent) :
		...
		m_guiBackground(new Gui(this, UiBound(Vector2(0.5f, 0.5f), "Centre", true, true, Vector2(1.0f, 1.0f)), new Texture("res/guis/black.png"), 1)),
		m_guiLogo(new Gui(this, UiBound(Vector2(0.5f, 0.5f), "Centre", true, true, Vector2(0.4f, 0.4f)), new Texture("res/logos/equilibrium-games-02.png"), 1)),
		m_textCopyright(new Text(this, UiBound(Vector2(0.5f, 0.18f), "Centre", true), 1.9f, "Copyright (C) 2017, Equilibrium Games - All Rights Reserved \n This product uses GLFW, Vulkan, and STB Image", Uis::Get()->m_proximanova->GetRegular(), JustifyCentre, 0.9, 0.0012f, 0.024f)),
		m_starting(true)
	{
