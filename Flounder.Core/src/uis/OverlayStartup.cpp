...
namespace Flounder
{
	OverlayStartup::OverlayStartup(UiObject *parent) :
		...
		m_textCopyright(new Text(this, UiBound(Vector2(0.5f, 0.18f), "Centre", true), 2.6f, "Copyright (C) 2017, Equilibrium Games - All Rights Reserved. This product uses GLFW, Vulkan, and STB Image.", Uis::Get()->m_cafeFrancoise->GetRegular(), JustifyCentre, 0.5f)),
		m_starting(true)
	{
