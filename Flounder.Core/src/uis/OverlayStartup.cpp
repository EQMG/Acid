...
namespace Flounder
{
	OverlayStartup::OverlayStartup(UiObject *parent) :
		...
		m_textCopyright(new Text(this, Vector3(0.5f, 0.18f, RelativeScreen), Vector2(0.5f, 0.5f), "Copyright (C) 2017, Equilibrium Games - All Rights Reserved. This product uses GLFW, Vulkan, and STB Image.", Uis::Get()->m_cafeFrancoise->GetRegular(), 2.0f, JustifyCentre, 0.5f)),
		m_starting(true)
	{
